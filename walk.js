...
const area = {
  ...
  function create(color, dx, dy, ballName) {
...
//   // TODO: implement the update function
  function update(ball, x, y) {
    console.log(ball.ballName + " requested to be at " + x + ", " + y);
    ...
    console.log(ball.ballName + " new location is at " + x + ", " + y);

    setTimeout(both, 1600);
  }

  function both(ball, x, y){
  ...
  initialize();
  const ball1 = create('blue', 4, 3, 'ball1');
  const ball2 = create('red', 1, 5, 'ball2');
  const ball3 = create('green', 2, 2, 'ball3');
  moveTo(ball1, 1, 1);
  moveTo(ball2, 10, 10);
  moveTo(ball3, 20, 20);
